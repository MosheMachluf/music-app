...
class Song {
    constructor(_parent, _img, _artist, _song, _duration, _mp3, _link, _rank, _album, _id_album, _rating) {
        this.parent = _parent;
        this.img = _img;
        this.artist = _artist;
        this.song = _song;
    ...
    renderBarTitle() {
        ...
        barTitle.innerHTML =
            `<h3 class="display-4 sm_title text-left">Result:</h3>
    ...
    renderSong() {
        ...
        playPause.addEventListener("click", function () {
            ...
            var songTime = setInterval(() => {
                var widthCurrTime = song.currentTime;

                document.documentElement.style.setProperty("--duration_width", "100%");
                document.documentElement.style.setProperty("--curr_time_width", widthCurrTime * 3.2 + "em");
        ...
        divName.innerHTML =
            `<h2 class="display-4 sm_title">${this.song}</h2>
